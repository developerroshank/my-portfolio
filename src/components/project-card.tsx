...
const Projects = [
  {
    ...
    short:
      "https://www.analyticssteps.com/backend/media/thumbnail/9877501/2072546_1669664501_AI%20in%20Storage%20ManagementArtboard%201.jpg",
    features: [
...

  {
    ...
    short: "https://cdn.jsdelivr.net/gh/elhussary/project-showcases/nfthub.mp4https://img.decrypt.co/insecure/rs:fit:3840:0:0:0/plain/https://cdn.decrypt.co/wp-content/uploads/2021/07/The-Bored-Ape-Yacht-Club-gID_7.jpeg@webp",
      ...
      {Projects.map((project, index) => (
        ...
        >
          <section className="lg:w-1/2">
            ...
            ></video> */}
            <img src="project.short" alt="Online Image" />
          </section>
